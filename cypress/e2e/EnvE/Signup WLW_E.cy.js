 describe('Create new account', () => {
    ...
    cy.writeFile('../Weekly_Smoke_Test_Report_Env E.html', '<p>WLW Checks:</p>'  + '\r\n' , {flag: 'a+'})
...
cy.get('body').then(($body) => {
      ...
      {
        cy.writeFile('../Weekly_Smoke_Test_Report_Env E.html', '<p> 1. WLW Account Creation:<span style="color: green;">Test is passed.</span></p>'  + '\r\n' , {flag: 'a+'})
      }
      else
      {
        cy.writeFile('../Weekly_Smoke_Test_Report_Env E.html','<p> 1. WLW Account Creation: <span style="color: red;">Test is failed.</p>' + '\r\n' , {flag: 'a+'})
      }
    })
